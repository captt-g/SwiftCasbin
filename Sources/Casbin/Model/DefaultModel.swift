...
extension DefaultModel:Model {
    ...
    public func getValuesForFieldInPolicy(sec:String,ptype:String,fieldIndex:Int) -> [String]  { let policy = getPolicy(sec: sec, ptype: ptype).reduce(into: Set<String>()) { acc, x in
